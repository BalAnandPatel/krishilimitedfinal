...
<p>1. Log into your Flipkart account</p>

<p>2. Go to My Orders</p>

<p>3. Click on 'Return' against the item you wish to return or exchange</p>

<p>4. Fill in the details and raise a return request</p>

<p>Once you raise a request, you'll get an email and SMS confirming that your request is being processed. 
    ...
    If the request is approved, the item will be picked up after which you will get a replacement or refund.
     You can also track the status of your return request instantly from the 'My Orders' section of your Flipkart account.</p>
...
<p>If you’ve done all of this and you still have not received your refund yet, please contact us at krishilimitedindia@gmail.com.</p>

<h4>Sale items (if applicable)</h4>
<p>Only regular priced items may be refunded, unfortunately sale items cannot be refunded.</p>

<h4>Exchanges (if applicable)</h4>
<p>We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at krishilimitedindia@gmail.com and send your item to: C/O DASRATH PAUL, OM NAGAR COLONY ARATEE NO. 86/320, SARNATH VARANASI Varanasi UP 221007 IN .</p>
...
<h4>Shipping</h4>
<p>To return your product, you should mail your product to: C/O DASRATH PAUL, OM NAGAR COLONY ARATEE NO. 86/320, SARNATH VARANASI Varanasi UP 221007 IN.</p>
