...
<section class="ab_msec">
  ...
  <div class="container">
    ...
    <div class="footer_content">
      <h4 class="font_size pb-2">Training</h4>
    </div>
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="assets/img/about/baag2.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Agriculture Training</h5>
        ...
        <div class="col">
          <div class="card h-100">
            <img src="assets/img/about/ssi.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Small Scale Industry Training</h5>
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h5 class="card-title">Beekeeping Training</h5>
              <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
        ...
        <div class="col">
          <div class="card h-100">
            <img src="assets/img/about/fishseed.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Egg Hechari Training</h5>
              <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
                content. This card has even longer content than the first to show that equal height action.</p>
            </div>
            <div class="card-footer">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="assets/img/about/ssi1.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
            ...
            <div class="card-footer">
              <small class="text-muted"><a href="training.php">Click here</a></small>
            </div>
          </div>
        </div>
      </div>
